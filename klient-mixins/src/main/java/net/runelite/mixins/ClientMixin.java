...
public abstract class ClientMixin implements RSClient {
  ...
  public static void gameStateChanged(int idx)
  {
    ...
    client.getCallbacks().post(meteor.eventbus.events.GameStateChanged.class, new meteor.eventbus.events.GameStateChanged(null, gameState));
  ...
  public static void onCycleCntrChanged(int idx) {
    client.getCallbacks().post(meteor.eventbus.events.ClientTick.class, meteor.eventbus.events.ClientTick.INSTANCE);
  }
  ...
  public static void canvasWidthChanged(int idx)
  {
    ...
    client.getCallbacks().post(meteor.eventbus.events.CanvasSizeChanged.class, meteor.eventbus.events.CanvasSizeChanged.INSTANCE);
  }
  ...
  static void copy$menuAction(int param0, int param1, int opcode, int id, String option,
    ...
    final MenuOptionClicked menuOptionClicked = new MenuOptionClicked(param0, option, target, MenuAction.of(opcode),
            id, client.getSelectedItemSlot(), canvasX, canvasY);
    ...
    copy$menuAction(menuOptionClicked.getActionParam(), param1,

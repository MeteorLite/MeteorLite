...
public class MeteorLiteClientModule extends AbstractModule {
  ...
  //Stub out ClientPacket. CBA. Will implement in Meteor before too long
  @Provides
  @Singleton
  ClientPacket provideClientPacket() {
    return new ClientPacket() {
      ...
      @Override
      public ClientPacket OPNPCU() {
        return null;
      }

      @Override
      public ClientPacket OPLOCU() {
        return null;
      }

      @Override
      public ClientPacket OPHELD1() {
        return null;
      }

      @Override
      public ClientPacket OPHELD2() {
        return null;
      }

      @Override
      public ClientPacket OPHELD3() {
        return null;
      }

      @Override
      public ClientPacket OPHELD4() {
        return null;
      }

      @Override
      public ClientPacket OPHELD5() {
        return null;
      }

      @Override
      public ClientPacket OPHELDU() {
        return null;
      }
      ...
      @Override
      public ClientPacket IF_BUTTON1() {
        return null;
      }

      @Override
      public ClientPacket IF_BUTTON2() {
        return null;
      }

      @Override
      public ClientPacket IF_BUTTON3() {
        return null;
      }

      @Override
      public ClientPacket IF_BUTTON4() {
        return null;
      }

      @Override
      public ClientPacket IF_BUTTON5() {
        return null;
      }

      @Override
      public ClientPacket IF_BUTTON6() {
        return null;
      }

      @Override
      public ClientPacket IF_BUTTON7() {
        return null;
      }

      @Override
      public ClientPacket IF_BUTTON8() {
        return null;
      }

      @Override
      public ClientPacket IF_BUTTON9() {
        return null;
      }

      @Override
      public ClientPacket IF_BUTTON10() {
        return null;
      }
      ...
      @Override
      public ClientPacket RESUME_P_COUNTDIALOG() {
        return null;
      }

      @Override
      public ClientPacket RESUME_P_STRINGDIALOG() {
        return null;
      }

      @Override
      public ClientPacket RESUME_P_NAMEDIALOG() {
        return null;
      }
